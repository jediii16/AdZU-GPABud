...
const DevFAQ = () => {
  return (
    <div className="min-h-screen bg-linear-to-br bg-[#f5f5f5] transition-colors duration-500">
      <div className="container mx-auto pt-10 px-4 sm:px-6 lg:px-8">
        <header className="text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl font-body mx-auto transition-colors duration-500">

...
const GradingScale = () => {
  return (
    <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-white rounded-xl shadow-sm border border-zinc-100 max-w-7xl mx-auto">
      <h3 className="text-zinc-900 mb-4 text-sm sm:text-base gap-2 font-heading flex items-center">
        AdZU Grading Scale
      </h3>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 text-sm sm:text-base font-body">
        ...
        <div>
          ...
          <div className="text-zinc-500">Above Average</div>
        </div>
        <div>
          <div className="text-zinc-900">2.5</div>
          <div className="text-zinc-500">High Average</div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="text-zinc-500">Low Average</div>
        </div>
        <div>
